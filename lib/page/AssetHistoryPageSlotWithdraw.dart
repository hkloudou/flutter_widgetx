...
Widget getWithdrawUserAssetHistoryDefaultItem(
  ...
  double pad1 = 8;
  double pad2 = 6;
  bool finishd = (e.meta["done"] as bool?) ?? true;
  ...
  return <Widget>[
    ...
    [
      Styled.text("${e.amount.startsWith("-") ? e.amount : "+" + e.amount}",
              style: style2)
          .expanded(flex: 1),
      Styled.text(finishd ? "完成" : "处理中", style: style2)
          .textColor(finishd ? EColor.main : Theme.of(context).primaryColor)
          .alignment(Alignment.center)
          .expanded(flex: 1),
      Styled.text(
              // datefor
